        ...
        return $('div', {className: 'container grid-md'}, [
            $('div', {className: 'popup', style: {margin: '2rem'}}, [
                ...
                $('div', {className: 'form-group'}, [
                    ...
                    $('label', {className: 'form-radio'}, [$('input', {type: 'radio', name: '__choiceID', value: 'ticket', checked: (this.state.choiceID === 'ticket'), onChange: this.onChoiceChange}), $('i', {className: 'form-icon'}), ' Saya ingin mengakses e-tiket yang telah saya dapatkan']),
                ]),
                $('div', {className: 'columns', style: {marginTop: '2rem'}}, [
                    ...
                    $('div', {className: 'column col-4 col-sm-6'}, $(Link, {to: '/order/' + this.state.choiceID, className: 'btn btn-success btn-block'}, ['Lanjut ', $('i', {className: 'icon icon-arrow-right'})])),
                ])
            ])
        ]);
    }
